...
import { guideSections } from '../data/content.js';
...
function HomePage() {
  ...
  return (
    <>
      <section className="hero" style={{ backgroundImage: `linear-gradient(90deg, rgba(237, 249, 231, .96) 0%, rgba(237, 249, 231, .84) 38%, rgba(237, 249, 231, .1) 72%), url(${heroImage})` }}>
